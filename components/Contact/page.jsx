...
const Contact = () => {
    return (
        <div className='flex flex-col items-start p-6 sm:p-10 lg:p-16 bg-white shadow-xl outline rounded'>
            <h1 className='text-3xl sm:text-4xl lg:text-5xl mb-4 text-green-500 font-bold '>Ready to start a conversation?</h1>
            <h2 className='text-lg sm:text-xl lg:text-2xl leading-10 mb-6 text-center text-gray-600 italic'>Get in touch with me through these contacts:</h2>
